...
class Train:
    ...
    def train(dataloader, model, loss_fn, optimizer, device="cpu", mode:"binary or multi"='binary'):
        ...
        if mode == 'binary':
            train_loss, train_accuracy = Train.test_binary_classification(dataloader, model, loss_fn, device)
        else:
            train_loss, train_accuracy = Train.test_multi_classification(dataloader, model, loss_fn, device)
    ...
    def fit(train_loader, val_loader, model, loss_fn, optimizer, epochs, save_best_model=True, 
        ...
        for epoch in range(epochs):
            train_loss, train_accuracy = Train.train(train_loader, model, loss_fn, optimizer, device=device, mode=mode)
            ...
            if mode == "binary":
                val_loss, val_accuracy = Train.test_binary_classification(val_loader, model, loss_fn, device=device)
            else:
                val_loss, val_accuracy = Train.test_multi_classification(val_loader, model, loss_fn, device=device)
